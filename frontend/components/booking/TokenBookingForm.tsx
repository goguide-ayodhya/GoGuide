...
export function TokenBookingForm({ onSubmit, isLoading }: TokenBookingFormProps) {
  ...
  const [quantity, setQuantity] = useState(booking.formData.quantity || '1')
  const [deliveryMethod, setDeliveryMethod] = useState(booking.formData.deliveryMethod || 'eticket')
