...
//     ? Math.round(packages.reduce((sum, pkg) => sum + pkg.price, 0) / totalPackages)
//     : 0;
//   const avgDuration = totalPackages > 0
//     ? (packages.reduce((sum, pkg) => sum + pkg.duration, 0) / totalPackages).toFixed(1)
//     : 0;
...
//                   <p className="text-xs uppercase tracking-[0.15em] font-semibold text-slate-500">Total</p>
//                   <p className="mt-2 text-2xl font-bold text-slate-950">{totalPackages}</p>
//                   <p className="text-xs text-slate-500">packages</p>
//                 </div>
//                 <div className="rounded-2xl border border-slate-200 bg-white/80 backdrop-blur p-4">
//                   <p className="text-xs uppercase tracking-[0.15em] font-semibold text-slate-500">Avg Price</p>
//                   <p className="mt-2 text-xl font-bold text-slate-950">₹{avgPrice.toLocaleString()}</p>
//                 </div>
//                 <div className="rounded-2xl border border-slate-200 bg-white/80 backdrop-blur p-4">
//                   <p className="text-xs uppercase tracking-[0.15em] font-semibold text-slate-500">Avg Days</p>
//                   <p className="mt-2 text-2xl font-bold text-slate-950">{avgDuration}</p>
//                 </div>
//               </div>
//             </div>
//           </section>
...
//                 <div>
//                   <p className="text-sm uppercase tracking-[0.24em] text-orange-600">Search & discover</p>
...
//                     <div>
//                       <p className="text-sm uppercase tracking-[0.2em] text-orange-600">Results</p>
...
//                 </div>
//                 <p className="text-lg font-semibold text-slate-950 mb-2">No packages found</p>
//                 <p className="text-sm text-slate-500">
//                   Try adjusting your search terms or filters to find the perfect tour.
//                 </p>
//               </div>
//             )}
//           </section>
