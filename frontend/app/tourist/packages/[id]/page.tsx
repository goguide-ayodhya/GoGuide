...
import { Clock, MapPin, Check, Users, Calendar, Star, ChevronRight } from "lucide-react";
        ...
        <div className="mx-auto max-w-7xl">
            ...
            <img
              ...
              onError={(e) => {
                (e.target as HTMLImageElement).src =
                  "https://via.placeholder.com/1200x400?text=Package+Details";
              }}
            />
          </div>
          ...
          <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
            ...
            <div className="lg:col-span-2 space-y-6">
              ...
              <div className="grid grid-cols-3 gap-4">
                <Card className="rounded-2xl border border-slate-200 bg-white p-4 shadow-lg shadow-slate-200/20">
                  ...
                  <div className="mt-2 flex items-center gap-2">
                    ...
                    <p className="text-xl font-semibold text-slate-950">{pkg.duration} days</p>
                  </div>
                </Card>
                <Card className="rounded-2xl border border-slate-200 bg-white p-4 shadow-lg shadow-slate-200/20">
                  <p className="text-xs uppercase tracking-[0.15em] text-slate-500 font-semibold">Group Size</p>
                  <div className="mt-2 flex items-center gap-2">
                    <Users className="h-5 w-5 text-orange-600" />
                    <p className="text-xl font-semibold text-slate-950">2-8 people</p>
                  </div>
                </Card>
                <Card className="rounded-2xl border border-slate-200 bg-white p-4 shadow-lg shadow-slate-200/20">
                  <p className="text-xs uppercase tracking-[0.15em] text-slate-500 font-semibold">Per Person</p>
                  <p className="mt-2 text-xl font-semibold text-orange-700">₹{pkg.price.toLocaleString()}</p>
                </Card>
              </div>

              {/* Description */}
              <Card className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/20">
                <h2 className="text-2xl font-semibold text-slate-950 mb-4">About This Package</h2>
              ...
              {/* What's Included */}
              <Card className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/20">
                <h3 className="text-xl font-semibold text-slate-950 mb-4">What's Included</h3>
                <div className="space-y-3">
                  {pkg.includes && pkg.includes.length > 0 ? (
                    ...
                    <div className="flex items-start gap-3">
                      <Check className="h-5 w-5 text-orange-600 flex-shrink-0 mt-0.5" />
                      <span className="text-slate-700 font-medium\">Guided tour experience</span>
                    </div>
                  )}
                </div>
              </Card>
              ...
              {/* Package Highlights */}
              <Card className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/20">
                <h3 className="text-xl font-semibold text-slate-950 mb-4">Package Highlights</h3>
                <div className="grid grid-cols-2 gap-4">
                  <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-orange-50 to-yellow-50 p-4">
                    ...
                    <p className="text-xs text-slate-600 mt-1">{pkg.location}</p>
                  </div>
                  <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-blue-50 to-cyan-50 p-4">
                    ...
                    <p className="text-xs text-slate-600 mt-1">{pkg.duration} days adventure</p>
                  </div>
                  <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-green-50 to-emerald-50 p-4">
                    ...
                    <p className="text-sm font-semibold text-slate-950">Group Size</p>
                    <p className="text-xs text-slate-600 mt-1">Intimate group tours</p>
                  </div>
                  <div className="rounded-2xl border border-slate-200 bg-gradient-to-br from-purple-50 to-pink-50 p-4">
                    ...
                    <p className="text-xs text-slate-600 mt-1">Curated experiences</p>
                  </div>
                </div>
              </Card>
            </div>
            ...
            <div className="lg:col-span-1">
              <div className="sticky top-8 space-y-6">
                ...
                <Card className="rounded-3xl border border-orange-200 bg-gradient-to-br from-orange-50 to-yellow-50 p-6 shadow-lg shadow-orange-100/30">
                  <p className="text-xs uppercase tracking-[0.15em] text-orange-700 font-semibold mb-2">Total Price</p>
                  <div className="mb-6">
                    <p className="text-4xl font-bold text-orange-700">₹{pkg.price.toLocaleString()}</p>
                    <p className="text-sm text-slate-600 mt-2">Per person • {pkg.duration} days</p>
                  </div>

                  <Button
                    onClick={() => router.push(`/tourist/packages/book/${pkg._id}`)}
                ...
                <Card className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/20">
                  <h4 className="text-sm font-semibold text-slate-950 mb-4 uppercase tracking-[0.15em]">Quick Details</h4>
                  <div className="space-y-3 text-sm">
                    <div className="flex justify-between items-center pb-3 border-b border-slate-200">
                      <span className="text-slate-600">Duration</span>
                      <span className="font-semibold text-slate-950">{pkg.duration} days</span>
                    </div>
                    <div className="flex justify-between items-center pb-3 border-b border-slate-200">
                      <span className="text-slate-600">Group Size</span>
                      <span className="font-semibold text-slate-950">2-8 people</span>
                    </div>
                    <div className="flex justify-between items-center pb-3 border-b border-slate-200">
                    ...
                    <div className="flex justify-between items-center">
                      ...
                      <span className="font-semibold text-slate-950">EN, HI</span>
                    </div>
                  </div>
                </Card>
                ...
                <Card className="rounded-3xl border border-slate-200 bg-white p-6 shadow-lg shadow-slate-200/20">
                  <div className="space-y-3">
                    <div>
                      <p className="text-sm font-semibold text-slate-950 mb-1">Have Questions?</p>
                      <p className="text-xs text-slate-600">Our travel experts are ready to help.</p>
                    </div>
                    <Button
                      variant="outline"
