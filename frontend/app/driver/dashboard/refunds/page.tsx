...
export default function RefundsPage() {
  ...
  const handleRequestRefund = async () => {
    ...
    try {
      // Find the payment for the selected booking
      const selectedBooking = bookings[0]; // In a real app, user would select this
      if (!selectedBooking) {
    ...
    <div className="space-y-6">
      ...
      <Dialog open={isRequestDialogOpen} onOpenChange={setIsRequestDialogOpen}>
        <DialogTrigger asChild>
          <Button className="bg-primary">Request New Refund</Button>
        </DialogTrigger>
        <DialogContent>
          <DialogHeader>
            <DialogTitle>Request Refund</DialogTitle>
            <DialogDescription>
              Submit a new refund request for a booking
            </DialogDescription>
          </DialogHeader>
                  ...
                  <tbody>
                    {filteredRefunds.map((refund) => (
                      ...
                      >
                        ...
                        <td className="p-3">
                          <Badge
                            className={`gap-2 ${getStatusColor(refund.status)}`}
                          >
