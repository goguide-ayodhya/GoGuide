...
export default function ProfilePage() {
  ...
  const [formData, setFormData] = useState({
    ...
    email: user?.email || "",
    bio: myDriver?.bio || "",
    speciality: Array.isArray(myDriver?.specialities)
      ? myDriver?.specialities[0] || ""
      : myDriver?.specialities || "",
    certification: myDriver?.certification || "",
    yearsOfExperience: myDriver?.yearsOfExperience || 0,
    languages: (myDriver?.languages || []) as string[],
    hourlyRate: myDriver?.hourlyRate || 0,
    reviews: myDriver?.totalReviews,
  });
  ...
  return (
    <div className="space-y-6">
      ...
      <Card className="bg-card border border-border">
        ...
        <CardContent>
          <div className="space-y-6">
            {/* {myDriver.reviews && mockReviews.length > 0 ? (
