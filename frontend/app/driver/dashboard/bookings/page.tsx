...
type RawDriverBooking = {
  _id: string;
  guideId?: { _id: string } | string;
  driverId?: { _id: string } | string;
  touristName: string;
  email: string;
  phone: string;
  groupSize: number;
  ...
  useEffect(() => {
    const fetchBookings = async () => {
      try {
        ...
        const formatted = data.map((b: RawDriverBooking) => ({
          id: b._id,
          // guideId: b.guideId?._id || b.guideId || b.driverId?._id || b.driverId || "",
