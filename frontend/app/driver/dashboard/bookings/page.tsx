...
export default function BookingsPage() {
  ...
  const { bookings, updateBookingStatus } = useDriverBooking();
        ...
        <CardHeader>
          <div className="flex items-center justify-between">
            <div>
              ...
              <CardDescription>{filtered.length} rides found</CardDescription>
            </div>
          ...
          booking={
            {
              ...
              paymentStatus: selectedBooking.paymentStatus.toLowerCase(),
            } as any
          }
          isOpen={isModalOpen}
