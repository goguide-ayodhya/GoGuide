    ...
    <Card>
      <CardHeader>
        <CardTitle className="flex items-center gap-2">
          ...
          <h1
            className={`${poppins.className} text-secondary font-bold text-2xl sm:text-4xl`}
          >
            {" "}
            Become a Driver
          </h1>
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4 ">
              ...
              <Input
                ...
                onChange={handleInputChange}
                required
                className={errors.driverAadhar ? "border-red-500" : "bg-muted"}
              />
              {errors.driverAadhar && (
            ...
            <div className="space-y-4">
              ...
              >
                <SelectTrigger
                  className={errors.vehicleType ? "border-red-500" : "bg-muted"}
                >
          ...
          <div className="space-y-4">
            ...
            <div className="space-y-4">
              ...
              <Input
                ...
                onChange={handleInputChange}
                required
                className={errors.vehicleNumber ? "border-red-500" : "bg-muted"}
              />
